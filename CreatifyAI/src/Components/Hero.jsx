  ...
  return (
    ...
    <div className='text-center mb-6'>
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        ...
        className='bg-primary text-white px-10 py-3 rounded-lg hover:sale-102 active:scale-95 transition cursor-pointer'
        >Start creating now</button>
        <button
        className='bg-white  px-10 py-3 rounded-lg hover:sale-102 active:scale-95 transition cursor-pointer'
        >Watch demo</button>
